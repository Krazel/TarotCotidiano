...
Status: internal iPhone implementation `0.8 (1)` of the approved English/Spanish Read, Learn, Cards and Settings MVP surfaces. A-059 implements the approved automatic/repeatable shuffle and persistent-deck Reading Table; public distribution remains blocked.

## Approved visual boundary

A-059 is governed by V-108–V-119. V-108/V-109 cover automatic entry shuffle, V-110/V-111 the empty persistent-deck table, V-112/V-113 partial placement, V-114/V-115 the complete persistent-deck table, V-116/V-117 the raised compact landscape state, V-118 the complete landscape state and V-119 the supporting motion/interaction sequence. These references supersede conflicting manual-entry shuffle, disappearing-deck and landscape behavior in V-086/V-087/V-097–V-106 and V-100 without deleting that history.

The live Read flow follows Ceremonial Obsidian and keeps the earlier selector/tutorial contracts: V-120 governs reading-kind selection, V-121 the neutral five-style grid and V-088 contextual tutorial navigation. Their information glyph is visually 22 points while its full control remains 44×44 points. V-064 governs only the stable dark translucent primary tab bar material. Learn Index and Reading Tutorials follow V-072/V-073; V-071 governs the concise three-section article template. Card detail uses the plain `Meaning / Significado` heading, while `In a reading / En una tirada` applies that meaning to the question and assigned position.
