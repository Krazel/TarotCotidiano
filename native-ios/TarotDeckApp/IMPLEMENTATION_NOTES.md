...
Settings follows V-131/V-132 and Support follows V-133/V-134; V-044's overlaid gear opens Settings from both empty and active Read Home states. Its app-owned selector atomically validates and swaps the complete English or Spanish UI/content snapshot. The public screen contains Language, Support the App, a persistent App Store write-review link, Privacy, Support and the localized version footer. Support uses seven real monthly StoreKit products with live localized prices, verified entitlements, restoration, management, Privacy and Terms; every level is functionally equivalent and the full app remains free.
