...
- `beginner-guide.v1.json`: four fixed foundations plus eight practical tutorials: seven built-in readings and custom-spread creation.
...
The guide validator fixes the four foundation IDs, eight tutorial IDs, titles, display order, three-section learning contract, and exact built-in/custom mappings. It does not record reading progress or completion.
