...
- Rama: `main`; `8e4f908cad8e032719e5c85e7758a39941552554` es la fuente exacta de TestFlight `0.4 (1)`. `c4273f71729f3507ac8745cfea5cf4d81dc10bda` permanece como fuente de `0.3 (1)`, `e065562720acbde92075f6f94fae5b357067b974` de `0.2.2 (1)`, `aaaa83fe8ea6d4c32f5da23d7ea75da50361ced4` de `0.2.1 (1)` y `602b9d1c235082c1533bd83036acc7b35cea7f88` de la IPA Local-QA `0.2 (1)`.
...
6. Settings S09.1 está integrado. A-049 cubre únicamente la subida ya ejecutada de `0.4 (1)` a TestFlight Internal Only. StoreKit, productos, testers externos, review y publicación siguen sin autorización. También siguen pendientes capturas finales y derechos de distribución pública.
