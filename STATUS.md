...
A-039 fija minimización estricta de datos e información pública. La auditoría cerró con R-027: la app no tiene red, cuentas, tracking, anuncios, analítica, StoreKit de compras, permisos ni SDK de terceros; guarda en el dispositivo idioma, selección de tirada, sesión/continuidad, favoritos, tiradas personalizadas y su borrador. `PrivacyInfo.xcprivacy` declara `UserDefaults/CA92.1`, el directorio local se excluye de backup antes de cualquier store y los validadores pasan. App Store Privacy `Data Not Collected` sigue siendo exacto. Marketing URL y Promotional Text permanecen vacíos; el contacto privado de App Review y el copyright obligatorio no se reproducen en el repositorio. La revisión bilingüe de Privacy/Support está sincronizada en las tres copias locales de páginas, pero no publicada. App Store Connect muestra condición trader; P-006 exige confirmarla verazmente antes de habilitar España.
...
5. **Preparado localmente:** Support y Privacy URLs responden públicamente y sus copias locales EN/ES ya describen 1/3/6/custom, ocho tutoriales y todos los estados guardados. Aún deben desplegarse y revalidarse contra la RC exacta. App Privacy sigue siendo `Data Not Collected`; edad preparada `13+`; accesibilidad conservadora `Dark Interface`; precio gratuito. España requiere confirmar verazmente DSA trader antes de habilitarla.
6. Settings A-061 está integrado en la candidata pública `1.0 (1)`: idioma, Rate mediante enlace persistente oficial, Privacy, Support y versión; no hay IAP, Restore, Terms ni filas simuladas. StoreKit de compras y productos no forman parte de 1.0. Faltan compile/runtime Xcode, capturas reales EN/ES, despliegue de páginas y cierre de DSA antes de seleccionar y enviar la build.
